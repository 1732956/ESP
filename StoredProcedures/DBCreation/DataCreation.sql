...
INSERT INTO Tbl_Product(Name, Brand, Description, MeasureUnit, MeasureQty, UnitNbr, QtyMin, QtyMax, QtyInventoryOut, Price,IsActive, CategoryID, SupplierID, LastUpdate, BarCodeId, SupplierCode)
VALUES('Filtreur a eau pour four', 'Alto-Shaam', 'Filtreur a eau pour four (compatible Rational)', 'unité', 1, 1, 10, 50, 1, 13.50, 1, 1, 1, GETDATE(), 'p000100', 'FI-26356'),
	  ('Balais pour plancher', 'Swiffer', 'Balais swiffer pour plancher des chambres', 'unité', 1, 6, 2, 15, 6, 26.25, 1, 4, 2, GETDATE(), 'p000101', '13605078');
